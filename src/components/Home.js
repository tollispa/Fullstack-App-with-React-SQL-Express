    ...
    return ( 
        <div style={{display: `${showFeed}`, position: "absolute", top:"10%", textAlign: "center"}}>
           ...
           onChange={(e) => setPost(e.target.value)}/><br/>
            ...
            <p style={{position: "relative", marginTop: "17px",borderRadius: "5px",boxShadow: "0 0 10px rgba(0, 0, 0, 0.2)", minWidth: "400px",padding: "15px"}}key={post.id}><span><span style={{fontWeight: "bold", boxShadow: "0 0 10px rgba(0, 0, 0, 0.2)", padding: "7px", borderRadius: "8px", position: "absolute", left: "10px"}}>{post.name}</span><img style={{height: "60px", width:"60px", borderRadius: "50%", marginLeft: "10px", marginBottom: "15px",display: "inline-block"}} 
